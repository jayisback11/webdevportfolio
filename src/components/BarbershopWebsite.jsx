  ...
  const services = [
    {
      ...
      price: "$35",
      desc: "Precision cut, hot towel finish, and professional style.",
      time: "45 min",
    },
    {
      title: "Skin Fade",
      price: "$45",
      desc: "Expert taper or bald fade with straight razor outline.",
      time: "60 min",
    },
    {
      title: "Beard Trim & Shape",
      price: "$25",
      desc: "Sculpting, sharp lineup, and premium beard oil treatment.",
      time: "30 min",
    },
    {
      title: "The Royal Combo",
      price: "$65",
      desc: "Signature haircut + Full beard grooming & facial steam.",
      time: "90 min",
    },
    {
      title: "Straight Razor Shave",
      price: "$40",
      desc: "Traditional hot lather shave with aromatic essential oils.",
      time: "45 min",
    },
    {
      title: "Kids Haircut",
      price: "$25",
      desc: "Ages 12 and under. Patient, quick, and stylish.",
      time: "30 min",
    },
  ];
  ...
  const barbers = [
    {
      ...
      bio: "15 years experience. Master of classic pompadours and skin fades.",
      img: "https://images.unsplash.com/photo-1618077360395-f3068be8e001?auto=format&fit=crop&q=80&w=500",
    },
    {
      name: "Leo Vance",
      bio: "Specializes in modern creative cuts and intricate beard designs.",
      img: "https://images.unsplash.com/photo-1503443207922-dff7d543fd0e?auto=format&fit=crop&q=80&w=500",
    },
    {
      name: "Julian Reyes",
      bio: "The king of the straight razor. Traditional techniques with a modern vibe.",
      ...
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-slate-100 py-4 px-6">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <nav className="hidden lg:flex items-center gap-8 font-bold text-xs uppercase tracking-widest text-slate-500">
            ...
            <a href="#location" className="hover:text-blue-600 transition">
              Location
            </a>
            <a
              href="#booking"
              className="bg-[#1B263B] text-white px-6 py-3 rounded-full flex items-center gap-2 hover:bg-blue-600 transition-all shadow-lg shadow-blue-900/20"
            >
          ...
          <button
            className="lg:hidden text-[#1B263B]"
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center relative z-10">
          ...
          >
            ...
            <h1 className="text-6xl lg:text-8xl font-black leading-[0.9] mb-6 uppercase tracking-tighter text-white">
              The Finest <br />{" "}
              <span className="text-blue-500">Craftsmanship</span> <br /> In
              Baton Rouge
            </h1>
            <p className="text-lg text-slate-300 mb-10 max-w-lg font-medium leading-relaxed">
              Step into a realm of precision and style. We combine traditional
              barbering techniques with modern aesthetics for the ultimate
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              <a
                href="#booking"
                className="bg-blue-600 text-white px-10 py-5 rounded-2xl text-lg font-black hover:bg-blue-500 shadow-2xl shadow-blue-500/40 transition-all text-center uppercase tracking-widest"
              >
                Book My Chair
              </a>
              <a
                href="#services"
                className="bg-white/10 backdrop-blur-sm border border-white/20 text-white px-10 py-5 rounded-2xl text-lg font-black hover:bg-white hover:text-[#1B263B] transition-all text-center uppercase tracking-widest"
              >
                Our Services
              </a>
            </div>
      ...
      <section id="services" className="py-24 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
            <div>
              <h2 className="text-blue-600 font-bold uppercase tracking-[0.2em] mb-4 text-sm">
                Service Menu
              </h2>
              <h3 className="text-4xl md:text-6xl font-black text-[#1B263B] uppercase tracking-tighter leading-none">
                Sharpen Your <br /> Appearance
              </h3>
            </div>
            <p className="text-slate-500 max-w-sm font-medium border-l-4 border-blue-600 pl-6">
              Every service includes a consultation, premium products, and our
              signature hot towel finish.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((s, i) => (
              <div
                key={i}
                className="p-10 rounded-[2.5rem] border border-slate-100 bg-slate-50/50 hover:bg-white hover:border-blue-500 hover:shadow-2xl transition-all group relative overflow-hidden"
              >
                <div className="relative z-10">
                  <div className="flex justify-between items-start mb-4">
                    <h4 className="text-2xl font-black text-[#1B263B] group-hover:text-blue-600 transition-colors uppercase tracking-tighter">
                      {s.title}
                    </h4>
      ...
      <section id="team" className="py-24 px-6 bg-[#1B263B]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-blue-500 font-bold uppercase tracking-[0.2em] mb-4 text-sm">
              The Artisans
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-12">
            {barbers.map((b, i) => (
              ...
              >
                ...
                <a
                  href="#booking"
                  className="inline-flex items-center gap-3 text-blue-500 font-black uppercase tracking-widest text-sm group-hover:text-white transition-all"
                >
      ...
      <section id="gallery" className="py-24 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h3 className="text-4xl font-black text-[#1B263B] uppercase tracking-tighter mb-4">
              Masterpiece Collection
            </h3>
            <a
              href="#"
              className="inline-flex items-center gap-2 font-bold text-slate-500 hover:text-blue-600 transition text-sm uppercase tracking-widest"
            >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <div
                key={i}
                className="aspect-square rounded-[2rem] overflow-hidden shadow-xl hover:scale-[1.03] transition-transform duration-500"
              >
                <img
                  src={img}
        ...
        <div className="max-w-5xl mx-auto bg-white rounded-[4rem] overflow-hidden shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)] flex flex-col md:row-reverse md:flex-row">
          <div className="p-16 md:w-1/2 bg-blue-600 text-white flex flex-col justify-center">
            ...
            <p className="text-blue-100 mb-8 font-medium text-lg leading-relaxed">
              Skip the wait. Our real-time booking system ensures your spot is
              secured with your favorite artisan.
            </p>
            <div className="space-y-4">
              {["Instant Approval", "SMS Reminders", "Secure Booking"].map(
                (text) => (
                  <div
                    key={text}
                    className="flex items-center gap-4 bg-white/10 p-3 rounded-2xl border border-white/10"
                  >
          ...
          <div className="p-16 md:w-1/2 flex flex-col items-center justify-center text-center">
            ...
            <h4 className="text-3xl font-black text-[#1B263B] uppercase mb-4 tracking-tighter">
              Ready For a Change?
            </h4>
            <p className="text-slate-500 mb-10 font-medium">
              Click below to open our secure booking portal via Square.
            </p>
      ...
      <section id="location" className="py-24 px-6 bg-white">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
          <div>
            ...
            <h3 className="text-4xl md:text-6xl font-black text-[#1B263B] uppercase tracking-tighter mb-10 leading-none">
              In The Heart <br /> of The City
            </h3>

            <div className="grid gap-10">
              <div className="flex gap-6">
                <div className="bg-slate-100 w-14 h-14 rounded-2xl flex items-center justify-center shrink-0">
              ...
              <div className="bg-slate-50 p-8 rounded-[2.5rem] border border-slate-100">
                <h5 className="text-xs font-black text-blue-600 uppercase tracking-widest mb-4">
                  Operating Hours
                </h5>
                <div className="space-y-2 font-bold text-[#1B263B]">
                  <div className="flex justify-between">
                    <span>Monday - Friday</span> <span>9:00 - 8:00</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Saturday</span> <span>8:00 - 6:00</span>
                  </div>
                  <div className="flex justify-between text-red-500 uppercase">
      ...
      <footer className="bg-[#1B263B] py-20 px-6 text-center text-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex justify-center gap-8 mb-12">
            <a
              href="#"
              className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center hover:bg-blue-600 hover:border-blue-600 transition-all"
            >
              <Instagram size={20} />
            </a>
            <a
          ...
          <p className="text-[10px] font-bold uppercase tracking-[0.5em] text-slate-500 mb-4 italic">
            The Gold Standard of Baton Rouge Grooming
          </p>
          <p className="text-xs text-slate-400">
            © 2024 THE CUT & CROWN • DESIGNED BY JAY CRISOSTOMO
          </p>
        </div>
      </footer>
    </div>
